...
export const updateSubscriptionAndPayment = async (req, res) => {
  try {
    ...
    if (bankAccount.balance < plan.price) {
      return res
        .status(400)
        .json({ error: "Insufficient balance to complete the transaction." });
    }
    ...
    doc
      ...
      .font("Helvetica")
      .text(
        "If you have any questions, please contact support@duhonesolutions.com.",
        { align: "center" }
      )
      .moveDown();
    ...
    return res.status(200).json({
      message:
        "Subscription updated successfully. A receipt has been sent to your email.",
